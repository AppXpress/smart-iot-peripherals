  ...
  var nDrawer = {
    ...
    init: function( config ){
      ...
      if( nDrawer.options.modifyViewContent ){
        ...
        viewContentMenu = document.getElementById( 'view-content-menu' );
        viewContentMenu.style.height = deviceH-nDrawer.options.topBarHeight+'px';
        viewContentMenu.style.top = 0;
