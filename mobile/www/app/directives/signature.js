...
angular.module('app.directives').directive('signaturePad', ['$window',
  function ($window) {
    'use strict';
    ...
    return {
      restrict: 'EA',
      replace: true,
      template: '<div class="signature" ng-style="{height: height + \'px\', width: width + \'px\'}"><canvas style="width:100%;height: 300px;background:#F3F3F3;"></canvas></div>',
      scope: {
        accept: '=',
        clear: '=',
        dataurl: '=',
      ...
      link: function (scope, element) {
        ...
        if (!scope.height) scope.height = '220px';
        if (!scope.width) scope.width = '568px';
